...
export declare const getDefaultConfig: <chains extends _chains, transports extends _transports>({ appName, appDescription, appUrl, appIcon, wallets, projectId, clientId, devOption: { connect, relayBase, walletDomain }, ...wagmiParameters }: GetDefaultConfigParameters<chains, transports>) => import("wagmi").Config<chains, transports, import("wagmi").CreateConnectorFn[]>;
export {};
