// based on https://github.com/willmcpo/body-scroll-lock/blob/master/src/bodyScrollLock.js
// but fix width issues: https://github.com/willmcpo/body-scroll-lock/issues/261
...
const locksIndex: Map<any, number> = new Map();
